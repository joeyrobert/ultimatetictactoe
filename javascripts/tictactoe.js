...
(function() {
  ...
  UltimateTicTacToe = (function() {
    ...
    function UltimateTicTacToe() {
      this.playRandom = __bind(this.playRandom, this);
    ...
    UltimateTicTacToe.prototype.resize = function() {
      ...
      this.scale = Math.min(windowWidth / 444, windowHeight / 444);
    ...
    UltimateTicTacToe.prototype.clickSquare = function(e) {
      ...
      i = $square.data('i');
      j = $square.data('j');
      if (!this.gameComplete && _.isUndefined(this.board[i][j]) && (i === this.activeGame || _.isUndefined(this.activeGame))) {
    ...
    UltimateTicTacToe.prototype.showWinners = function(turn, i) {
      ...
      if (this.gameFull(this.gameWinners) && overallWinners.length === 0) {
        $(".game").removeClass('active');
        ...
        $(".game").removeClass('active');
        this.gameComplete = true;
        return this.showWinnerModal(turn);
      }
    };
    ...
    UltimateTicTacToe.prototype.playRandom = function() {
      var _this = this;
